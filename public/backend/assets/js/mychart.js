...
const myAreaChart = new Chart(areaChart, {
    type: 'bar',
    data: {
...
// Doughnut Chart
const doughnutCart = document.getElementById('doughnutChart').getContext('2d');
const myDoughnutChart = new Chart(doughnutCart, {
    type: 'doughnut',
    data: {
        labels: ['Red', 'Blue', 'Yellow', 'Green', 'Purple', 'Orange'],
        datasets: [{
